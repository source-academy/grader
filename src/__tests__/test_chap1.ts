...
const validStudentCorrect = `const f = i => i === 0 ? 0 : i < 3 ? 1 : f(i-1) + f(i-2);`

const validStudentWrong = `const f = i => i < 3 ? 2 : f(i-2) + f(i-3);`

const validStudentPartial = `const f = i => i < 3 ? 1 : f(i-1) + f(i-2);`

const invalidStudentRuntime = `const f = i => f(j+1);`

const invalidStudentSyntax = `const f = i => i === 0 ? 0 : i < 3 ? 1 : f(i-1) + f(i-2)`

const invalidStudentTimeout = `const f = i => f(i);`
